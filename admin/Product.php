...
if ($PName=='' or $PGender=='' or $PColor=='' or $PCurrency='' or $imagefile=='' or $Pdetails=''){
  ...
  elseif($article_number[0]=='k'){
    ...
    echo"Script>alert('Please enter appropriate article number!')</script>";
  }
...
oninvalid="this.setCustomValidity('Please write artical-number')" oninput="this.setCustomValidity('')">
  ...
  <input type="text" id="Product-details" name="Pdetails" value="" placeholder="Write Details Of Product"  rows="4" cols="50" minlength="10" required 
  oninvalid="this.setCustomValidity('Enter Product details Here')" oninput="this.setCustomValidity('')"/>
