...
<body>
    ...
    <div class="header">
        <div class="logo">
            <img src="img\zapatosLogo.png" width="200" height="100" alt="logo">
        </div>
        <div class="topNav">
            <ul>
                <li><label for="click" class="click-me">Sign in</label></li>
                <li><a href="customer-register.html">Register</a></li>
                <li><a href="#"><i class="fa fa-shopping-cart" style="font-size:22px"></i></a></li>
            </ul>
        </div>
    </div>
